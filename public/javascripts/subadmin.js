...
$('.save').click(function(){
  ...
  else if($('#email').val()==[] || $('#email').val()=="") alert('Enter Email')
    ...
    <div class="col">
      <div class="card bg-default shadow">
        <div class="card-header bg-transparent border-0">
          <h3 class="text-white mb-0">All Sub Admin List</h3>
          <br>
            ...
            <tbody>
                  ...
                  $.each(board, function(i, item) {
                    ...
                    <th scope="row">
                      <div class="media align-items-center">
                        <div class="media-body">
                        <a href='/admin-enquiry?id=${item.id}'>  <span class="mb-0 text-sm">${item.name}</span> </a>
                        </div>
                      </div>
                    </th>
